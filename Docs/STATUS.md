...
>
> **Last updated:** 2026-08-11 · **Latest public:** v1.0.48 · **v1.0.52 = loose-loot REAL fix (native ActivateRef on main thread; VM Activate was silently failing on every gold pile) atop v1.0.49-51; pushing to CI** · inruo debug branch open (#71) · **#62/#66/#67 shipped**
