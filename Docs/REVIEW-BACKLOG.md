...
### MFO-B117 (SEV-4) -- LOTD: the museum snapshot's VM read races Papyrus
...
### MFO-B118 (SEV-4) -- LOTD: alternative items over-count what is needed
...
### MFO-B119 (SEV-5) -- LOTD: a reload before arrival can ship one duplicate
...
### MFO-B120 (SEV-4) -- LOTD: the in-transit ledger floor can leak for the session
...
### MFO-B121 (SEV-4) -- LOTD: the same base shipped from two crates releases a ledger entry early
...
### MFO-B122 (SEV-4) -- LOTD: an off-role relic kept for the deposit can be auto-equipped and then never shipped
