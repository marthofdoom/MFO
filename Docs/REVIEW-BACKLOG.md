...
### MFO-B111 (SEV-4) -- swap-up: the ammo peek ignores carry weight
...
### MFO-B112 (SEV-4) -- swap-up: ComputeKeepSet runs inside the loot peek
...
### MFO-B113 (SEV-4) -- swap-up: VendorTrades(null) on a TESAmmo keyword form
