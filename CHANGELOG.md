...
- **A shield a dual wielding follower can never use again gets sold.** MFO tells Harbinger not to put a shield back on a follower whose perks vote for two weapons. Nothing ever took the shield off, though, and the shop pass keeps anything a follower is wearing. So it sat on his arm forever, unusable and unsellable. A worn item in a category MFO itself has ruled out now goes through the same sale route that already handles gear MFO wants gone, and the sale takes it off his arm. Gem sockets and quest items are still protected.
