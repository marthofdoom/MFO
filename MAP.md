...
- **§HMS PLAYER-RATE PARITY (PRGN v8, 2026-09-23, marth "fix b (with retroactive
  ...
  Now `RecomputeHMS` (`ProgAllocator_Hms.cpp:252`) applies `min(engineAward,
  ...
  or reordering it before the v7 block desyncs the stream.
