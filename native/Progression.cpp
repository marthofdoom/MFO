...
#include "Config.h"
#include "Forms.h"   // §18.6: the addon-manifest sentinel
...
namespace MFO::Progression {
    ...
    void Init() {
        ...
        // addons — each owns its manifest outright). Runs AFTER
        // Forms::Resolve (plugin.cpp order); sentinel unresolved = MFO.esp
        // itself is broken, logged there.
