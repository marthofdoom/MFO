// logistics/Economy.cpp -- the #21 ECONOMY: mage-apparel scoring, vendor lists,
// the College tome-gate unlock, buy thresholds, EconomyProbe (sell + buy) and
// the public GEAR/TOME buy helpers shared with TradeBridge::PlanBuy.
