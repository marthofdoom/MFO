...
namespace MFO::Forms {
    ...
    // §18.6 ADDON API: the registration sentinel. An MFO addon = one FLST
    // manifest whose FIRST entry is this keyword; Progression::Init
    // enumerates every such manifest across the merged load order. The
    // full frozen contract lives in Docs/ADDON-API.md.
